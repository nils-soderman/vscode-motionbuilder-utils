...
class FBAnimationNode(FBComponent):
    ...
    def KeyCandidate(self,Time:Optional[typing.Union[pyfbsdk.FBTime, NoneType]]=None):...
    def KeyRemove(self):
        """Remove key at current time."""
    def KeyRemoveAt(self,Time:FBTime):
        """Remove key at a given time."""
    @overload
    def ReadData(self,EvaluateInfo:Optional[typing.Union[pyfbsdk.FBEvaluateInfo, NoneType]]=None,bConvertGlobalToLocal:bool=False)->list:...
    @overload
    ...
    def WriteData(self,Data:list,EvaluateInfo:Optional[typing.Union[pyfbsdk.FBEvaluateInfo, NoneType]]=None)->int:
...
class FBVideoClip(FBVideo):
    ...
    def DrawImage(self,X=None,Y=None,W=-1,H=-1,Frame=-1):
